...
* **Clear Outputs:** Results are displayed in easy-to-read lists of **Recommended Foods** and **Foods to Avoid**.

## Compliance Reports
* **Detailed Tracking:** Pharmacists can view comprehensive reports detailing exactly which medicines were taken, missed, or skipped per day for every individual patient.

## Bulk Patient Import
* **Excel Uploads:** Pharmacists can upload an Excel file containing patient data.
* **Automated Parsing:** The backend parses the file using the xlsx library and securely registers all patients in a single batch process.
...
* **/auth** — Handles Super Admin, Pharmacist, and Patient logins, as well as self-registration.
